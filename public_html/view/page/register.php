...
<head>
	...
	<title>Dignity For Volunteer - Register</title>
	<base href="{{base_url}}" />
	...
	<link href="css/register.css?ts=1556705653" rel="stylesheet" type="text/css" />
	<ga-code/>
	...
	<div class="root">
		<div class="vbox wb_container" id="wb_header">
			...
			<div class="wb_cont_inner">
				<div id="wb_element_instance35" class="wb_element wb-menu">
					<ul class="hmenu">
						<li><a href="Home" target="_self">Home</a></li>
						<li><a href="Event/" target="_self">Event</a></li>
						<li><a href="Upcoming/" target="_self">Upcoming</a></li>
						<li class="active"><a href="Register/" target="_self">Register</a></li>
					</ul>
					<div class="clearfix"></div>
				</div>
				<div id="wb_element_instance36" class="wb_element wb_element_picture" title="">
		...
		<div class="vbox wb_container" id="wb_main">
			...
			<div class="wb_cont_inner">
				...
				<div id="wb_element_instance39" class="wb_element wb_text_element" style=" line-height: normal;">
					...
					<div id="wb_element_instance40" class="wb_element wb_element_shape">
						<div class="wb_shp"></div>
					</div>
					<div id="wb_element_instance41" class="wb_element wb_text_element" style=" line-height: normal;">
						<h1 class="wb-stl-heading1">About us</h1></div>
						<div id="wb_element_instance42" class="wb_element wb_text_element" style=" line-height: normal;">
						...
						<div id="wb_element_instance43" class="wb_element wb_element_picture" title=""><img alt="gallery/big_ring" src="gallery_gen/5652020a1bdb066641b0172598a54c5b.png"></div>
				...
				<div class="vbox wb_container" id="wb_footer">
					...
					<div class="wb_cont_inner" style="height: 144px;">
						...
						<div id="wb_element_instance45" class="wb_element" style="text-align: center; width: 100%;">
