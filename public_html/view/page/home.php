...
<head>
	...
	<title>Dignity For Volunteer</title>
	<base href="{{base_url}}" />
	...
	<link href="css/home.css?ts=1556705653" rel="stylesheet" type="text/css" />
	<ga-code/>
			...
			<div class="wb_cont_inner">
				...
				<div id="wb_element_instance4" class="wb_element wb_text_element" style=" line-height: normal;">
					...
					<div id="wb_element_instance8" class="wb_element wb_text_element" style=" line-height: normal;">
						...
						<p> </p>
						<p class="wb-stl-custom2"><strong>Dignity for Children Foundation is a non-governmental organization that provides holistic care and education for urban poor children in Kuala Lumpur, Malaysia.</strong></p>
						<p> </p>
						<p class="wb-stl-custom2">Dignity <strong>primarily operates Harvest Learning Centre that serves over 1000 children and youth aged 1-18 years.</strong> Other than operating education programmes in Sentul, Dignity also supports other community schools working with poor children in South East Asia through its <strong>community-school start up</strong> and teachers’ training programmes.</p>
					</div>
					<div id="wb_element_instance9" class="wb_element"><a class="wb_button" href="About/"><span>Register Event</span></a></div>
					<div id="wb_element_instance10" class="wb_element wb_text_element" style=" line-height: normal;">
						<h5 class="wb-stl-subtitle" style="text-align: center;">Dignity for volunteer</h5></div>
						<div id="wb_element_instance11" class="wb_element wb_text_element" style=" line-height: normal;">
							<p class="wb-stl-normal" style="text-align: center;"><span style="color:#ffffff;">This text should be replaced with information about you and your business This text should be replaced with information about you and your business This text should be replaced with information...</span></p>
						</div>
